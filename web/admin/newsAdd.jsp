        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <table border="0" cellspacing="0" class="tbedit">
                <tr>
                    ...
                    <td align="left">
                        <input type="text" name="ntitle" id="" class="longtxt" value="" /><span class="errorinfo" id="">请输入名称</span>
                    </td>
                </tr>
                <tr>
                    <th width="280" align="right" scope="row">*Release time：</th>
                    <td align="left">
                        <input type="text" name="ndate2" id="" class="txtDate" value=""/><span class="errorinfo" id="">不能为空或格式不对</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left">
                        <textarea name="ndesc" class="contxt"></textarea><span class="errorinfo" id="">请上传图片</span></td>
                </tr>

                <tr>
                    <th width="280" align="right" scope="row">*Content：</th>
                    <td align="left">
                        <textarea  name="ncontent" id="" class="acontent"></textarea><span class="errorinfo" id="">请上传图片</span>
                    </td>
                </tr>
                <tr>
                    <th scope="row">&nbsp;</th>
